<h1 align="center"><b>0x17. WEB STACK DEBUGGING #3</b></h1>
...
- You can use [tmux](https://hamvocke.com/blog/a-quick-and-easy-guide-to-tmux/) to run [strace]() in one window and `curl` in another one
